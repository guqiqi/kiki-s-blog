<template>
  <div>
        ...
        <div style="margin-top: 2%">
          ...
          <Row style="margin-top: 2em; margin-bottom: 2em">
            ...
            <i-col v-bind:span="24-avatar-offset" v-bind:offset="offset">
              <div v-bind:style="{marginLeft: offset?0:.7+'em'}" style="font-size: 1.1em; text-align: left; font-weight: bold; color: black; margin-top: .1em">
                {{this.name}}
              </div>
              <div v-bind:style="{marginLeft: offset?0:.7+'em'}" style="font-size: 1em; text-align: left; margin-top: .3em">{{this.date}} &nbsp&nbsp&nbsp 阅读
                {{this.reader}}
              </div>
            </i-col>
          </Row>
    ...
    <!--<div style="width: 90%; margin-left: 5%; height: auto; border: 1px solid #dedede; padding: 5px">-->
